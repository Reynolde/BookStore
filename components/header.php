<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="index.php"><img src="public/img/logoEfood.jpg" alt=""></a>
        </div>
        <div id="mobile-menu-wrap"></div>
        
        <?php if(isset($_SESSION['user'])) { ?>
        <div class="offcanvas__auth acount mt-4 ">
        ...
        ?>
            <div class="offcanvas__auth mt-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__right">
                        ...
                        ?>
                            <div class="header__right__auth mt-4">
                                <a href="index.php?url=dang-nhap">Đăng nhập</a>
                                <a href="index.php?url=dang-ky">Đăng ký</a>
                            </div>
                        <?php 
